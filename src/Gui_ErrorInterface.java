...
public class Gui_ErrorInterface {
    ...
    public Gui_ErrorInterface() {
        ...
        if (Gui.topicSelector == 0) {
            label.setText("You have not selected at least one topic.");
        } else if (Gui.quesionSelector == 0) {
            label.setText("You have not selected a question type.");
        }
